---
{"dg-publish":true,"permalink":"/代码开发/Web 前端/2 类型系统/TypeScript/05 类和接口/02 继承/","dg-note-properties":{}}
---
...
那么`override`是什么？`override`是 TS4.x 新增的一个关键字，使用该关键字修饰后的方法表示这个方法是一个重写覆盖父类的方法，如果子类中的方法没有在父类只出现过，则不能使用`override`。
