---
{"dg-publish":true,"permalink":"/🔵 代码开发/Web 前端/4 前端框架/React18/22 Scheduler 调度普通任务/","dg-note-properties":{}}
---
...
- 根据传入的 `priorityLevel` 优先级属性，会进行不同的 `timeout` 的设置，任务的 `timeout` 时间也就不一样了，有的比当前时间要小，也就表示这个任务需要立即执行，绝大部分的时间比当前时间大；
	- ![](/img/user/%F0%9F%94%B5%20%E4%BB%A3%E7%A0%81%E5%BC%80%E5%8F%91/Web%20%E5%89%8D%E7%AB%AF/4%20%E5%89%8D%E7%AB%AF%E6%A1%86%E6%9E%B6/React18/_assets/2022-12-29-065931.png)
- 不同的任务最终调用的函数不一样：
